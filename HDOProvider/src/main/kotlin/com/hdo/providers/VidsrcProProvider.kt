    ...
    companion object {
        ...
        suspend fun getVideoLinks(
            ...
            return try {
                ...
                val hashDecodeJson = String(base64DecodeArray(hashEncode))
                ...
                val firstDecodeBase64 = String(base64DecodeArray(mEncrypt))
                ...
                val secondDecodeJson = String(base64DecodeArray(secondDecodeBase64))
